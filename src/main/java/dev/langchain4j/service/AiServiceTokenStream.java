...
public class AiServiceTokenStream implements TokenStream {
    ...
    // 新增：onPartialToolCallWithContext 方法
    @Override
    ...
    public void start() {
        ...
        // 修改：传递 partialToolCallHandler 和 partialToolCallWithContextHandler
    ...
    private void validateConfiguration() {
        ...
        // 新增：验证 onPartialToolCall
        if (onPartialToolCallInvoked + onPartialToolCallWithContextInvoked > 1) {
            throw new IllegalConfigurationException("One of [onPartialToolCall, onPartialToolCallWithContext] " +
                    "can be invoked on TokenStream at most 1 time");
        }

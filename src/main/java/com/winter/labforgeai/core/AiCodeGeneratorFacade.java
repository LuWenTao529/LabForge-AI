...
import com.winter.labforgeai.core.parser.CodeParserExecutor;
import com.winter.labforgeai.core.saver.CodeFileSaverExecutor;
...
//    <-----------------------------------------!流式！-----------------------------------------!>
    ...
    /**
     * 通用处理代码流的方法
     * 该方法接收一个代码流和代码生成类型，处理代码流并最终保存生成的代码
     *
     * @param appId 应用程序ID
     * @param codeStream 代码流
     * @param codeGenType 代码生成类型
     * @return 返回处理后的代码流，包含实时收集的代码片段
     */
    private Flux<String> processCodeStream(Flux<String> codeStream, CodeGenTypeEnum codeGenType, Long appId) {
        ...
        return codeStream.doOnNext(chunk -> {
                    ...
                    // 流式返回完成后保存代码
                    try {
                        String complete = codeBuilder.toString();
                        // 使用执行器解析代码
                        Object parsedResult = CodeParserExecutor.executeParser(complete, codeGenType);
                        // 使用执行器保存代码

package com.winter.labforgeai.service.impl;
...
import com.winter.labforgeai.mapper.ChatHistoryMapper;
...
public class ChatHistoryServiceImpl extends ServiceImpl<ChatHistoryMapper, ChatHistory>  implements ChatHistoryService{
     ...
     * 获取查询包装类
     *
     * @param chatHistoryQueryRequest 查询请求对象，包含查询条件参数
     * @return QueryWrapper 返回构建好的查询包装对象，用于数据库查询
     */
    @Override
    public QueryWrapper getQueryWrapper(ChatHistoryQueryRequest chatHistoryQueryRequest) {
        ...
        // 如果设置了最后创建时间，则查询创建时间小于该值的数据，用于分页
